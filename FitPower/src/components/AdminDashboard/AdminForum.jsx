...
export default function AdminForum() {
    ...
    const fetchTopics = useCallback(() => {
        ...
        apiFetch(`/admin/forum/topics?${params}`)
            ...
            .catch(() => swalError('Error loading topics'))
    }, [search])
    ...
    const deleteTopic = async (id) => {
        if (!(await confirmSwal('Delete this topic?'))) return
            ...
            <div className="ad-dash-card" style={{ margin: '24px' }}>
                <table className="ad-table">
                    ...
                    <tbody>
                        ...
                        {topics.length === 0 && <tr><td colSpan={7} style={{ textAlign: 'center', color: 'var(--text-muted)', padding: 32 }}>No topics found</td></tr>}
                    </tbody>
                </table>
            </div>
        </div>
