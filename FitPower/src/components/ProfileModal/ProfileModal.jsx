...
export default function ProfileModal({ isOpen, onClose, onSaved }) {
    ...
    const [form, setForm] = useState({ firstName: '', lastName: '', email: '', photo: '' })
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit} className="pm-form">
                        <div className="pm-avatar-section">
                            <img loading="lazy"                                 src={form.photo && (form.photo.startsWith('http://') || form.photo.startsWith('https://')) ? form.photo : 'https://picsum.photos/seed/default/120/120.jpg'}
                                alt=""
                                className="pm-avatar"
                            />
                        </div>
